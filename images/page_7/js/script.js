...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./images/page_7/FICHA00.png",
            "./images/page_7/FICHA01.png",
            "./images/page_7/FICHA02.png",
            "./images/page_7/FICHA03.png",
            "./images/page_7/FICHA04.png",
            "./images/page_7/FICHA05.png",
        ],
        memorama: [],
